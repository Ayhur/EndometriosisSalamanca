...
// 						    		out.println("<input type='radio' name='" + pregunta.getTipo() + "_" + pregunta.getIdpregunta() + "' id=rad"+i+"_"+j+" value='" + respuestasRadio[j] + "'> " + respuestasRadio[j] + "&nbsp;&nbsp;&nbsp;");
				...
				for(Medicamento medicamento : listaMedicamentos){
					out.println("<tr>");
						out.println("<td class='leftElement'>"+medicamento.getNombreMed()+"</td>");
						out.println("<td><input type='checkbox'	id='check"+medicamento.getNombreMed()+"'	name='check"+medicamento.getNombreMed()+"'></td>");
						out.println("<td><input type='radio' 	name='radio"+medicamento.getNombreMed()+"'	value='bien' disabled></td>");
						out.println("<td><input type='radio' 	name='radio"+medicamento.getNombreMed()+"' 	value='mal' disabled></td>");
					out.println("</tr>");
				}
				out.println("</table>");
			...
			<input type="submit" value="Volver" formaction="endometriosis.jsp">
			        ...
			        if ('SI'.toUpperCase() === this.value.toUpperCase()) {
			        	...
			        	$.ajax({
							...
							success : function(json) {
								...
								if(undefined === json.length){	 // trae 1 elemento
									// elimino el elemento
									var elementoHTML = "#cajaDependeciaPregunta"+json.idpregunta;
									$(elementoHTML).remove();
								}
								else{							// trae mas de 1 elemento
